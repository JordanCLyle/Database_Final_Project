...
<body>
<h3>Enter information about the applications you want to view from the database:</h3>

How would you like to view the applications?
<form action="view_applications.php" method="post">
    <div>
        <select name="formSearch">
            <option value="'A'">All</option>
            <option value="'B'">By major</option>
            <option value="'C'">From a particular student</option>
            <option value="'D'">From a particular job</option>
...
if(isset($_POST['formSubmit'])) 
{
    ...
    $input = "''";
    $command = 'java -cp .:mysql-connector-java-5.1.40-bin.jar view_applications ' . $selectionChoice . ' ' . $input;
