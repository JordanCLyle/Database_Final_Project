...
<body>
<h3>Enter information about a student you want to add to the database:</h3>
...
if (isset($_POST['submit'])) 
{
    ...
    $command = 'java -cp .:mysql-connector-java-5.1.40-bin.jar add_student ' . $StudentId . ' ' . $StudentName . ' ' . $Major;
